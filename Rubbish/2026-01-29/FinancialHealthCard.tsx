...
export default function FinancialHealthCard({
  ...
  const calculateHealthScore = () => {
    ...
    // Formula: (Revenus - Dépenses) / Revenus
    let savingsRatePoints = 0;
    let calculatedSavingsRate = 0;
    if (totalsRevenusDepenses?.revenus?.real) {
      const savingsRate = ((totalsRevenusDepenses.revenus.real - totalsRevenusDepenses.depenses.real) / totalsRevenusDepenses.revenus.real) * 100;
