...
export default function Dashboard({ transactions,
  ...
  // CORRECTION: Déduire l'épargne du solde (solde = revenus - dépenses - épargne)
  ...
  // CORRECTION: Inclure les épargnes futures dans la déduction (prévision = solde - dépenses futures - épargnes futures)
