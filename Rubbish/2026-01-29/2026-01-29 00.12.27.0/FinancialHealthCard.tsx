...
export default function FinancialHealthCard({
  ...
  const calculateHealthScore = () => {
    ...
    if (totalsRevenusDepenses?.revenus?.real) {
      // Ajout du totalObjectifsEnCours dans le numérateur
      const savingsRate = ((totalsRevenusDepenses.revenus.real - totalsRevenusDepenses.depenses.real + totalObjectifsEnCours) / totalsRevenusDepenses.revenus.real) * 100;
    ...
    return {
      ...
      cashFlow,
      avgMonthlyExpenses,
      totalObjectifsEnCours // Ajouté pour affichage/debug éventuel
    };
  };
