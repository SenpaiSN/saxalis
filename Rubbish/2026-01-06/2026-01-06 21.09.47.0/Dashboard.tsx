...
export default function Dashboard({ transactions,
  ...
  return (
    <div className="p-3 lg:p-6 space-y-4" style={{ paddingBottom: 'calc(env(safe-area-inset-bottom, 0px) + 1.5rem)' }}>
      {/* DEBUG: bandeau d'information (transactions reçues) */}
      <div style={{background: 'red', color: 'white', padding: 8, textAlign: 'center', zIndex: 9999}}>
        DEBUG: Dashboard monté, transactions: {transactions.length}
      </div>
