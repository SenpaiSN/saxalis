...
function App() {
  ...
  const ajouterTransaction = async (transaction: Omit<Transaction, 'id'>, file?: File | null) => {
    ...
    if (isAuthenticated === false) {
      ...
      if (transaction.type === 'dépense' || transaction.type === 'depense' || transaction.type === 'expense') type = 'dépense';
      else if (transaction.type === 'revenu' || transaction.type === 'income') type = 'revenu';
      else if (transaction.type === 'epargne' || transaction.type === 'saving' || transaction.type === 'savings') type = 'epargne';
