...
export default function Dashboard({ transactions,
  ...
  const transactionsFiltrees = transactions.filter(t => {
    ...
    // Si aucun filtre (recherche, type, catégorie, année, mois) n'est sélectionné,
    // on applique par défaut l'année et le mois courants **sauf** si l'utilisateur a demandé "Afficher tout".
    ...
    // subcategory may be stored as `subcategoryName`, `subCategory` or as an id in `subcategoryId` — match by name or id
