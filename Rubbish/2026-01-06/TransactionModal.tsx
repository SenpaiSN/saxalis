...
import { X, FilePlus, Calendar, Repeat, ShoppingCart, DollarSign } from 'lucide-react';
...
export default function TransactionModal({
  ...
  const [montant, setMontant] = useState(initialValues.montant || '');
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <span className="absolute right-3 top-2.5 text-gray-400"><EuroIcon /></span>
            </div>
          </div>
          <div>
