...
// Liste des sous-catégories toujours fixes (normalisées)
...
export default function FixedVsVariableExpensesCard({ 
  ...
  const expenseData = useMemo(() => {
    ...
    categoryMonthMap.forEach((monthData, category) => {
      // Normalisation de la catégorie pour la comparaison
      const normalizedCategory = category.trim().toLowerCase();
      if (ALWAYS_FIXED_SUBCATEGORIES.includes(normalizedCategory)) {
